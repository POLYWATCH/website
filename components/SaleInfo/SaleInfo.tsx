...
export default function SaleInfo({ nft }: Props) {
  ...
  const { register: registerDirect, handleSubmit: handleSubmitDirect } =
    useForm<DirectFormData>({
      defaultValues: {
        ...
        endDate: new Date(),
        price: "0",
        assetContractAddress: "0x4C2c8D14DA3D7aB9355BAB303158BDe73C857809",
        currency: "matic", // Impostato su 'matic' di default
      },
    });
  ...
  async function handleSubmissionAuction(data: AuctionFormData) {
    ...
    const txResult = await createAuctionListing({
      ...
      currencyContractAddress: "0x860B897081E3B764104a1FFF2bdBe688Ed3cf6BA"
    });
  ...
  async function handleSubmissionDirect(data: DirectFormData) {
    ...
    const txResult = await createDirectListing({
        ...
        startTimestamp: new Date(data.startDate),
        endTimestamp: new Date(data.endDate),
        currencyContractAddress: data.currency === '0x0000000000000000000000000000000000001010' ? '' : '0x860B897081E3B764104a1FFF2bdBe688Ed3cf6BA',
    });
